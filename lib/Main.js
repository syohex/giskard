...
var Main = function(config) {
     ...
     * @private
     */
    this._logger = new Logger(Logger.LEVEL.INFO, 'Giskard');

    /**
     *
     * @type {string}
     */
    this._configPath = config || Main.DEFAULT_CONFIG_PATH;
    ...
    /**
     * If true giskard is using the default config file
     * @type {boolean}
     * @private
     */
 ...
 * @param {*} data
 */
Main.prototype._applyConfig = function(callback, err, data) {
    ...
    if (err) {
        ...
        fs.readFile(Main.DEFAULT_CONFIG_FILE, this._applyConfig.bind(this, callback));
 ...
 */
Main.prototype._loadConfig = function (path, callback) {
 ...
 * @param  {*} signal
 */
Main.prototype._workerExit = function(worker, code, signal) {
 ...
 */
Main.prototype._startWorkers = function() {
    ...
    cluster.setupMaster({exec : require.resolve(Main.DEFAULT_INSTANCE), args: [], silent : false});
 ...
 */
Main.prototype._updateWorkers = function() {
 ...
 * @param  {Object} worker
 */
Main.prototype._workerReloadDisconnect = function(worker) {
 ...
 * @param {Object} worker
 */
Main.prototype._workerReloadListening = function(i, worker) {
 ...
 * @param {number=} i
 */
Main.prototype._reloadWorkers = function(i) {
 ...
 * @return {string}
 */
Main.prototype.config = function(path) {
    if (path !== undefined) {
 ...
 * @const
 */
Main.MAIN_PROCESS_TITLE = 'Giskard - master';
