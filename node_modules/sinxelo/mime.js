...
module.exports = {
	...
	/**
	 * Return the type for an specified extension
	 * @method
	...
	/**
	 * Return the extension for an specified type
	 * @method
	 * @param type String
	 * @return String
	 */
	extensions: function(type, subtype) {
		...
		if (!type || !subtype || !types[type.toLowerCase()]) { return false; }

		return types[type.toLowerCase()][subtype.toLowerCase()];
	}
